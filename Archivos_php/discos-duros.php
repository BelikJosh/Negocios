...
<head>
    ...
    <title>DakCom - Discos Duros</title>
...
try {
    ...
    $sql = "SELECT Id_Inventario, Nombre_categoria, Tipo, Nombre_Producto, Precio, Descripcion, Especificaciones, Fecha, Img 
            ...
            WHERE inventario.Id_cat = categorias.ID AND Tipo='SSD'";
...
<div class="array">
    ...
    <div class="contenedor2">
        <div class="subtitulos">
            <span><h2 class="normal">Llévate almacenamiento <strong class="negrita">de sobra</strong></h2></span>
        </div>
        <div class="cont-cat">
        <?php
        ...
        ?>
            <div class="productos">
                <a href="#" class="link">
                    <img class="rdondear centrarimg" src="<?php echo $productos['Img']; ?>" alt="Disco Duro">
