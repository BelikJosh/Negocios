...
const IntermediateCarePatients = () => {
    ...
    return (
      <View style={styles.background}>
        <View style={styles.header}>
          <Text style={styles.title}>Alta de Pacientes en Cuidados Intermedios</Text>
        </View>
...
export default IntermediateCarePatients;
