...
try {
    ...
    $sql = "SELECT Id_Inventario, Nombre_categoria, Tipo, Nombre_Producto, Precio, Descripcion, Especificaciones, Fecha, Img 
            ...
            WHERE inventario.Id_cat = categorias.ID AND inventario.Id_cat = 6";
...
<div class="array">
    ...
    <div class="contenedor2">
        <div class="subtitulos">
            <span><h2 class="normal">Todos los <strong class="negrita">celulares</strong></h2></span>
        </div>
        <div class="cont-cat">
        <?php
        ...
        ?>
            <div class="productos">
                <a href="#" class="link">
                    <img class="rdondear centrarimg" src="<?php echo $productos['Img']; ?>" alt="Celulares">
