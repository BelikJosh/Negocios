...
<head>
    ...
    <title>DakCom - Procesadores</title>
...
try {
    ...
    $sql = " SELECT Id_Inventario, Nombre_categoria, Tipo, Nombre_Producto, Precio, Descripcion, Especificaciones, Fecha, Img 
             ...
             WHERE inventario.Id_cat = categorias.ID AND Tipo='Procesador'";
...
<div class="array">
    ...
    <div class="contenedor2">
        <div class="subtitulos">
            <span><h2 class="normal">Encuentra el <strong class="negrita">procesador ideal</strong></h2></span>
        </div>
        <div class="cont-cat">
        <?php
